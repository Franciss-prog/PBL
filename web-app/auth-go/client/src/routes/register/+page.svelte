...
<main class="flex min-h-screen items-center justify-center bg-gray-100">
	<section class="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
		...
		<form class="space-y-4" on:submit={onRegister}>
			<label class="block">
			...
			<button class="w-full rounded-lg bg-blue-500 py-3 text-white transition hover:bg-blue-600">
				Register
			</button>
			<span>Already have an Account? <a href="/" class="underline">Login Here</a></span>
		</form>
	</section>
</main>
